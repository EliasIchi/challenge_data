...
-- SE DEJA OPORTUNIDAD DE BORRAR LOS DATOS DE LA TABLA MANTENIENDO EL FORMATO CON EL TRUNCATE
-- TRUNCATE TABLE MY_DB.MY_SCHEMA_REPLICA_PROD.BUSINESS;

----BUSINESS TABLE----
--CREATE DDL
CREATE TABLE IF NOT EXISTS  DBT.AVENU_SCHEMA.BUSINESS
(
	ID VARCHAR(256),
...
--INSERT DATA--
INSERT INTO DBT.AVENU_SCHEMA.BUSINESS (ID, CUSTOMER_ID, STATUS, NAME, TAX_ID, REGISTRATION_NUMBER, TYPE, ADDRESS, _FIVETRAN_DELETED, _FIVETRAN_SYNCED) 
(
  SELECT
  'USMYMTRPZ8',
...
-- REALIZAR CONSULTA SQL PARA VERIFICAR SI SE CARGARON CORRECTAMENTE LOS DATOS:

SELECT
*
FROM
DBT.AVENU_SCHEMA.BUSINESS
LIMIT 10;
-- VERIFICAR TIPO DE DATOS, TAL COMO SOLICITA LA CONSIGA, ADDRESS SE MANTIENE TIPO VARIANT
DESCRIBE TABLE MY_DB.MY_SCHEMA_REPLICA_PROD.BUSINESS;
