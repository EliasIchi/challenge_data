...
-- TRUNCATE TABLE MY_DB.MY_SCHEMA_REPLICA_PROD.CUSTOMER;

create table IF NOT EXISTS DBT.AVENU_SCHEMA.CUSTOMER
(
	ID VARCHAR(256),
...
--INSERT DATA--
INSERT INTO DBT.AVENU_SCHEMA.CUSTOMER (ID, APPLICANT_ID, STATUS, TAX_ID, ADDRESS, EMAIL, PHONE_NUMBER, FIRST_NAME, LAST_NAME, VERSION, _FIVETRAN_DELETED, _FIVETRAN_SYNCED)
(
  SELECT
